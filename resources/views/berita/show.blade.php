        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-8 md:p-12">
                ...
                <div class="mt-12 pt-8 border-t border-gray-200">
                    <h3 class="text-lg font-bold text-gray-900 mb-4">Bagikan Berita</h3>
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('berita.show', $berita->slug)) }}&text={{ urlencode($berita->judul) }}" 
                           target="_blank"
                           class="share-btn bg-sky-500 hover:bg-sky-600">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
<style>
    ...
    .share-btn {
        @apply inline-flex items-center space-x-2 px-4 py-2 rounded-lg text-white font-medium transition-colors duration-200;
    }
    .prose {
